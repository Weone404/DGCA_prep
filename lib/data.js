...
export const QUESTION_BANK_CHAPTERS_EXPORT = QUESTION_BANK_CHAPTERS
...
export const SHORT_VIDEOS_DATA = {
  'Short Videos': {
    icon: '⚡',
    subtitle: 'Quick revision clips for last-minute prep',
    examTags: ['Quick', 'Revision'],
    color: '#7B7FF2',
    videos: [
      {
        title: 'Short Video: Pressure and Altimetry',
        chapter: 'Meteorology',
        description: 'Fast recap of pressure systems and altimetry basics.',
      ...
      },
      {
        ...
        iframeCode: '<iframe width="560" height="315" src="https://www.youtube.com/embed/Xl5tnrStees?si=" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
        duration: '4 min',
      },
      {
...
export const PERSONALYSIS_DATA = {
  'Personalysis Lectures': {
    ...
    videos: [
      {
        title: 'Personalysis: Weather Interpretation',
        chapter: 'Meteorology',
        description: 'How to read weather patterns in a practical exam setup.',
      ...
      },
      {
        ...
        iframeCode: '<iframe width="560" height="315" src="https://www.youtube.com/embed/OPf0YbXqDm0?si=" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
        duration: '14 min',
      },
      {
        title: 'Personalysis: Aircraft Systems Review',
        chapter: 'Technical General',
        description: 'A premium revision session on core aircraft systems.',
