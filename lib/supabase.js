...
export function normalizeScheduledClass(record) {
  return {
    ...
    createdAt: getValue(record, ['created_at', 'createdAt', 'set_at', 'setAt'], ''),
  }
}
...
export function normalizeAssignedTest(record) {
  return {
    ...
    classId: getValue(record, ['class_id', 'classId', 'batch_id', 'batchId'], ''),
    className: getValue(record, ['class_name', 'className', 'batch', 'batch_name', 'batchName'], ''),
    ...
    createdAt: getValue(record, ['created_at', 'createdAt', 'assigned_at', 'assignedAt'], ''),
  }
}
