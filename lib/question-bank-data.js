...
import { chapters as rnChapters, questions as rnQuestions } from './question-banks/question_bank_rn'
...
const BANK_MODULES = [
  ...
  { id: 'general-navigation', subject: 'General Navigation', chapters: gnChapters, questions: gnQuestions },
  { id: 'radio-navigation', subject: 'Radio Navigation', chapters: rnChapters, questions: rnQuestions },
  { id: 'meteorology', subject: 'Meteorology', chapters: metChapters, questions: metQuestions },
  { id: 'instrument-navigation', subject: 'Instrument Navigation', chapters: instrumentChapters, questions: instrumentQuestions },
...
export const QUESTION_BANK_SUBJECTS = [
  ...
  { id: 'general-navigation', name: 'General Navigation', color: '#FF8B6B' },
  { id: 'radio-navigation', name: 'Radio Navigation', color: '#EF4444' },
  { id: 'instrument-navigation', name: 'Instrument Navigation', color: '#0F766E' },
