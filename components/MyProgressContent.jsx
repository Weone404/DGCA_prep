...
export default function MyProgressContent() {
  const { progressSubjects: PROGRESS_SUBJECTS } = useAppContent()
  ...
  return (
    <>
      <div>
        ...
        {[
          { label: 'Courses in progress', value: USER.coursesInProgress || 0, color: 'text-violet' },
          { label: 'Courses completed', value: USER.coursesComplete || 0, color: 'text-brand' },
