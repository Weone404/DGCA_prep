  ...
  return (
    <AppShell>
      <main>
        ...
        <div className="card flex min-h-[calc(100svh-9rem)] max-h-[calc(100svh-6rem)] flex-col overflow-hidden">
        <div className="flex items-center gap-3 border-b border-line px-4 py-3 sm:px-6 sm:py-4">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-4 py-4 sm:px-6 sm:py-5">
          {messages.map((m) => (
            <div key={m.id} className={`flex ${m.role === 'user' ? 'justify-end' : 'justify-start'}`}>
              <div className={`max-w-[88%] break-words rounded-2xl px-4 py-3 text-sm leading-relaxed sm:max-w-[75%] ${
        ...
        <div className="flex items-center gap-2 border-t border-line px-4 py-3 sm:gap-3 sm:px-6 sm:py-4">
          <input
            value={input}
